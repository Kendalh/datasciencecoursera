...
par(mfcol = c(2,2))
#plot 1
with(sdata, plot(DateTime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
#plot 2
...
#plot 3
with(sdata, plot(DateTime, Voltage, type="l", xlab="datetime", ylab="Voltage"))
#plot 4
with(sdata, plot(DateTime, Global_reactive_power, type="l", xlab="datetime"))
